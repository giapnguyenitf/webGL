...
<body>
  <div id="app">
    ...
    <div class="annotation">
      ...
      <a href="/import" target="_blank">Import new model</a>
      <a href="/hotspots" target="_blank">Add new hotspot</a>
      <a class="btn btn-sm btn-info send-message-btn">Send message</a>
    </div>
  </div>
